...
class FormValueCell: FormBaseCell {
    ...
    override func configure() {
        ...
        valueLabel.font = UIFont(name: "GothamRounded-Medium", size:15.0);
        ...
        let leftMarginConstraint:NSLayoutConstraint = NSLayoutConstraint(item: self.valueLabel, attribute: NSLayoutAttribute.Left, relatedBy: NSLayoutRelation.Equal, toItem: self.contentView, attribute: NSLayoutAttribute.Left, multiplier: 1, constant: 120)
