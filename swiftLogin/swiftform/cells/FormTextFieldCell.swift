...
class FormTextFieldCell: FormBaseCell,UITextFieldDelegate {
    ...
    override func configure() {
        ...
        let leftMarginConstraint:NSLayoutConstraint = NSLayoutConstraint(item: self.textField, attribute: NSLayoutAttribute.Left, relatedBy: NSLayoutRelation.Equal, toItem: self.contentView, attribute: NSLayoutAttribute.Left, multiplier: 1, constant: 120)
